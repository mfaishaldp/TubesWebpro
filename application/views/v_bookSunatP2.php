...
<div class="navigation">
    ...
    <form action="<?php echo site_url('c_bookSunatP/pilTanggal'); ?>" method="post">
        ...
        <div class="card text-center w-50 p-3 mx-auto" dispay:block >
            ...
            <div class="card-body text-centered">
                <div class="row">
                    <div class="col-3"> </div>
                    <div class="col-6">
                    <h6 class="card-title">Book Dokter</h6>
                        <div class="form-group dropdown">
                            <select name="pilDokter" id="pilDokter">
                                <div class="dropdown-menu">
                                    <?php foreach ($listDokter as $ld):  ?>
                                    <option class="dropdown-item" value="<?php echo $ld->username; ?>"><?php echo $ld->nama; ?></option>
                                    <?php endforeach ?>
                                </div>
                            </select>
                        </div>
